...
caused, and how it was resolved. Kept because the failure mode this project studies —
measurements that look solid and are not — is the same failure mode the project itself is
exposed to.
